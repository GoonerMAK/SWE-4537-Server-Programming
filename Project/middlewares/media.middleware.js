...
const pgnStorage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, "uploads");
  },
  filename: function (req, file, cb) {
...
const uploadPgnFile = multer({ storage: pgnStorage });
...
module.exports = { uploadImage, uploadProfileImage, uploadAudioFile, uploadPgnFile };
